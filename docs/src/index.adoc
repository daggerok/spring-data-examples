= spring-data-examples {project-name} ({project-version})
...
ifdef::backend-html5[GitHub CI build status: image:https://travis-ci.org/daggerok/{root-project-name}.svg?branch=master["Build Status", link={github_url}]]
